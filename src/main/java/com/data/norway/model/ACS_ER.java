...
public class ACS_ER {
	...
	public ACS_ER(String id, String req_type, String obj_text, String val_statement, String val_evidence,
			String val_proof_measure, String val_result, String ac_condition, String validates) {
		super();
		this.id = id;
		this.req_type = req_type;
		this.obj_text = obj_text;
