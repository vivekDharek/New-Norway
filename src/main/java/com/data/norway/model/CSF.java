...
public class CSF {
	...
	public CSF(String id, String req_type, String obj_text, String val_statement, String val_evidence, String val_proof,
			String ac_condition, String val_result, String validates) {
		super();
		this.id = id;
		this.req_type = req_type;
		this.obj_text = obj_text;
